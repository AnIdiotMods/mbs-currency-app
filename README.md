...
Flutter mobile app prototype for Missouri Boys/Girls State digital currency operations.

## Highlights
- Provider-based state management
- Dark theme (`#121212` / `#1E1E1E`)
- Citizen, corporate, and admin account models
